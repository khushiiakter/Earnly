...
const ProfilePage = () => {
    ...
    return (
        <div className="flex min-h-screen  p-6">
          {/* Sidebar */}
          <aside className="w-1/4  p-6 rounded-xl shadow-md">
            ...
            <div className="mt-5 border-t pt-4">
              <p className=" mb-2">Registered: {user.registered}</p>
          ...
          <main className="flex-1 ml-6  p-6 rounded-xl shadow-md">
            <div className="flex justify-between items-center mb-4">
              <h1 className="text-2xl font-bold">Profile</h1>
              <button className="bg-[#5f1a89]  px-4 py-2 rounded-lg">Edit Profile</button>
            </div>
        ...
        <div className="mt-6  p-6 rounded-lg h-64">
