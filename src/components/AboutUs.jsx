      ...
      <div>
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
          <li className="flex items-center">
            ...
            <p className="">Seamless Task Management</p>
          </li>
          <li className="flex items-center">
            <span className="bg-green-100  p-2 rounded-full mr-3">
             
            </span>
            <p className="">Secure Payments and Withdrawals</p>
          </li>
          <li className="flex items-center">
            <span className="bg-green-100  p-2 rounded-full mr-3">
              
            </span>
            <p className="">User-Friendly Interface</p>
          </li>
          <li className="flex items-center">
            <span className="bg-green-100 p-2 rounded-full mr-3">
              
            </span>
            <p className="">Verified User Feedback</p>
          </li>
        </ul>
