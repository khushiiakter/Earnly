        ...
        <div className=" py-8 ">
            <div className="p-5">
                <div className="text-center mb-8">
                    <h2 className="text-4xl font-bold text-[#5f1a89]  mb-4">About Us</h2>
                ...
                <div className="flex md:flex-row flex-col gap-9 p-6 items-center justify-between">
                    {/* Left Section: Text */}
                    <div className="">
                        <p className="px-2 text-center md:text-left  mb-5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-6">
                            ...
                            <div className="flex items-center md:text-left text-center flex-col md:flex-row space-y-2 md:space-x-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold ">Buyer</h3>
                                    <p className="text-sm ">
                            ...
                            <div className="flex items-center md:text-left text-center flex-col md:flex-row space-y-2 md:space-x-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold ">Genuine User Reviews</h3>
                                    <p className="text-sm ">
